...
//   { value: "", label: "Select Client Portfolio..." },
//   { value: "client_1", label: "Acme Corp" },
//   { value: "client_2", label: "Globex Inc." },
//   { value: "client_3", label: "Initech Ltd." },
// ];
...
export const CreateNewFiling: React.FC<{
  ...
  const [clientId, setClientId] = useState(searchParamsClientId || "");
  ...
  // ── Submit ─────────────────────────────────────────────────────────────────
  const handleSubmit = () => {
    if (!type || !dueDate || !clientId) return;
              ...
              <CustomCard classname="border border-neutral-200!">
                ...
                {customDocInput ? (
                  ...
                  <button
                    ...
                    className="mt-3 flex w-full px-2  items-center justify-center gap-1.5 rounded-xl border border-dashed border-neutral-300 py-2.5 text-xs font-semibold uppercase tracking-widest text-neutral-400 hover:border-brand-primary hover:text-brand-primary transition cursor-pointer"
                  >
                    <Plus size={13} />
                    Add Custom Requirement
                  </button>
...
export default CreateNewFiling;
